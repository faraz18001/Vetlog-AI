...
# Below are minimal tools for demonstration purposes(copied straight from the langgraph documentation).


# this usese sql lite raw queries to pullout data not usefull because i am using sqlalachamey library here!!.
@tool
...
def get_llm_model():
    ...
    if provider == "ollama":
        ...
        return ChatOpenAI(
            api_key=open_ai_key,
            model=os.getenv("DEFAULT_MODEL", "gpt40"),
            temperature=0.2,
        )
